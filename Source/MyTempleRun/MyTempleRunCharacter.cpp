...
AMyTempleRunCharacter::AMyTempleRunCharacter()
{
...
void AMyTempleRunCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void AMyTempleRunCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
